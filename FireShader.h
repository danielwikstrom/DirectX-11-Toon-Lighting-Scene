...
public:
	...
	bool SetShaderParameters(ID3D11DeviceContext* context, DirectX::SimpleMath::Matrix* world, DirectX::SimpleMath::Matrix* view, DirectX::SimpleMath::Matrix* projection, Light* sceneLight1, float time, DirectX::SimpleMath::Vector2 tile = DirectX::SimpleMath::Vector2(1, 1), ID3D11ShaderResourceView* texture1 = NULL, ID3D11ShaderResourceView* texture2 = NULL, ID3D11ShaderResourceView* texture3 = NULL);
